...
#Custom Code
@api.check(2, "Custom control wait has timed out.")
def control_click_wait(title, control, delay, **kwargs):
    """
...
def control_wait_visible(title, control, delay, buf_size=256,  **kwargs):
    """
